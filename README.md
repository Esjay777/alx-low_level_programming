#!/bin/bash
StartingC - Pointers, arrays and strings
#TASKS
1.	98 Battery st.
...
You are allowed to use the standard library You don’t have to pass the betty-style tests (you still need to pass the betty-doc tests) man srand, rand, time gdb and objdump can help C today
